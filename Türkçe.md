# Kaboom Gizlilik Politikası
Kaboom'u kullandığınız için teşekkür ederiz! Gizliliğinize saygı duyuyoruz ve uygulamamızı kullanırken sağladığınız tüm bilgileri korumaya kararlıyız. Verilerinizin nasıl işlendiğini anlamak için lütfen bu Gizlilik Politikasını okuyun.

## Toplamadığımız Bilgiler
Kaboom, kullanıcılarından kişisel bilgi veya veri toplamaz. Kullanımınızı izlemeyiz, kişisel bilgilerinizi depolamayız veya üçüncü taraflarla veri paylaşımı yapmayız.

## Üçüncü Taraf Hizmetleri
Kaboom, belirli özellikler veya işlevler için üçüncü taraf hizmetlerini entegre edebilir. Uygulamamızda reklamlar göstermek için Google AdMob'u kullanıyoruz. AdMob, kişiselleştirilmiş reklam amaçlarıyla cihazınızdan belirli bilgileri toplayabilir. Bu bilgiler cihaz kimlikleri, IP adresleri ve kullanım verilerini içerebilir. AdMob'un veri toplama ve kullanımı hakkında daha fazla bilgi için lütfen Google'ın Gizlilik Politikasını inceleyin.
